<?php
    ...
    class Authentication extends Dbc
    {
        ...
        public function login_admins($user, $password)
        {
            $stmt = $this->connect()->prepare('SELECT * FROM admins WHERE admin_user_name = :user_name and admin_pass = :pwd');
            $stmt->execute([':user_name' => $user, ':pwd' => $password]);
