    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="side" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
                    class="fas fa-user-secret me-2"></i>F&G HOTEL</div>
            <div class="list-group list-group-flush my-3">
                ...
                <a href="../Controllers/logout.conadmin.php" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="../Controllers/logout.conadmin.php">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
