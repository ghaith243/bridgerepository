<?php
    ...
    function get_room_data()
    {
        ...
        $local_id = 1;
        echo '<button data-toggle="modal" data-target="#EpicModal3" class="add_room" style="float: right; color: white;"><i class="fas fa-plus-circle text-success"></i> Add Room</button>';
    ...
    function reservations_data()
    {
        ...
        function get_pension_data()
        {
            ...
            foreach ($result as $row) {
                ...
                echo '<td><button data-toggle="modal" data-target="#EpicModal2" class="edit_pension" id="' . $row['pension_id'] . '" href="#"><i class="fas fa-edit text-warning"></i></button><a class="delete_room" id="' . $row['pension_id'] . '" href="#" ><i class="fas fa-trash text-danger delete_room" ></i></a></td>';
                echo '</tr>';
            }
        }
